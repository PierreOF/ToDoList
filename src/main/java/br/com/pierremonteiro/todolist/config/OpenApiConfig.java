...
@OpenAPIDefinition(info = @Info(contact = @Contact(name = "Pierre Monteiro",email = "marcos.pierre@upe.br",url = "https://www.linkedin.com/in/pierremont/"),description = "ToDoList usando java + Spring para estudos",title = "Java ToDoList",version = "1.0"),servers = {@Server(description = "local enviroment",url = "http://localhost:8080"),@Server(description = "production enviroment",url = "https://todolist-nz2u.onrender.com")},security = {@SecurityRequirement(name = "basicAuth")})
